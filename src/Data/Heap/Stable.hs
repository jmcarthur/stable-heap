...
-- priority queues. The data structure is technically original, but
-- closely related to pairing heaps, in particular the lazy pairing
-- heaps described in /Purely Functional Data Structures/, by Chris
-- Okasaki.
--
